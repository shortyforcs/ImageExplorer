...
import main.java.com.lynden.gmapsfx.javascript.JavaFxWebEngine;
import main.java.com.lynden.gmapsfx.javascript.JavascriptRuntime;
...
public class GoogleMapView extends AnchorPane {
    ...
    protected static final String GOOGLE_MAPS_API_LINK = "https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=true&callback=initialize";
    ...
    public GoogleMapView(String mapResourcePath, String language, String region, String key, boolean debug) {
        ...
        if (mapResourcePath == null) {
            if (debug) {
                ...
                htmlFile = "../../../../resources/html/maps.html";
            }
        } else {
        ...
        Runnable initWebView = () -> {
            try {
                ...
                */
                ...
                java.net.URL url = getClass().getResource(htmlFile);
